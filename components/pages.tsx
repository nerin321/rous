...
const Pages = () => {
  return (
    <section>
      <div className="mb:mb-20 mb:gap-28 grid items-center grid-cols-2 gap-5 mb-5">
        <h3 className="mb:text-5xl text-sm">
          Where Technology Meets Financial Growth
        </h3>
        <div>
          <p className="text-[8px] mb:text-base">
      ...
      <div className="bg-mobile-img mb:block hidden bg-center bg-no-repeat bg-contain">
      ...
      <div className="relative text-[8px] mb:hidden">
        <img
          src={PagesBg.src}
          alt=""
          className="absolute w-[181px] -z-10 top-10 left-24"
        />
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <div className="bg-white/10 rounded-2xl flex flex-col items-center w-1/3 gap-2 p-3 text-center">
              ...
              <h3 className="text-xs font-medium">Data Analytics Tools</h3>
              <p>
                Unlock the full potential of your financial data with Rous's
                advanced Data Analytics Tools.
              </p>
